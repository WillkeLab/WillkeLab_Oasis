![docker image](https://github.com/WillkeLab/WillkeLab_Oasis/actions/workflows/docker-publish.yml/badge.svg)

# WillkeLab's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of WillkeLab.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/WillkeLab/WillkeLab_Oasis.git
    cd WillkeLab_Oasis
    ```
    ...
    ```sh
    curl -L -o WillkeLab_Oasis.zip "https://github.com/WillkeLab/WillkeLab_Oasis/archive/main.zip"
    unzip WillkeLab_Oasis.zip
    cd WillkeLab_Oasis
    ```
...
your `docker-compose.yaml` with `ghcr.io/willkelab/willkelab_oasis:main` for the services
...
```sh
docker pull ghcr.io/willkelab/willkelab_oasis/jupyter:main
```
...
- _I get an_ `Error response from daemon: Head "https://ghcr.io/v2/willkelab/willkelab_oasis/manifests/main": unauthorized` _when trying to pull my docker image._
